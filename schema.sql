-- =====================================================
-- SCHEMA NORTHWIND
-- Script gerado via MySQL Workbench
-- Responsável pela criação da estrutura do banco
-- =====================================================
-- Os dados utilizados já vêm populados no banco Northwind.
-- O arquivo `schema.sql` contém apenas a estrutura das tabelas.
